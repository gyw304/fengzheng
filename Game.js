...
Kiteflying.Game.prototype = {
    create: function() {
        ...
        this.bg = this.add.tileSprite(0,0,Kiteflying.GAME_WIDTH,Kiteflying.GAME_HEIGHT,'gameBg');//背景�?
    ...
    showGameOverTxt : function(){
        ...
        this.scoreTxt = this.add.text(150, 118, "��ķ��ݷɵ���" + this.bmpText.text +"��\n�ɵ���"+this.village[this.rd(0,this.village.length-1)]+'С��', this.style);
